...
import { PageContainer, ProCard, QueryFilter, ProFormText } from '@ant-design/pro-components';
...
const Dishes = () => {
  ...
  return (
    <PageContainer title="Quản lý món ăn">
      <ProCard>
        <QueryFilter defaultCollapsed onFinish={handleSearch} split>
