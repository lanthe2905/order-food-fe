...
export default [
  ...
  },
  {
    ...
    name: 'disher',
    icon: 'shopping',
    component: '@/pages/admin/disher/index.tsx',
  },
  {
    path: '/ingredients',
    name: 'ingredients',
  ...
  },
  {
    ...
    routes: [
      {
        path: ROUTES.ADMIN.DISHES.LIST,
        component: '@/pages/admin/dishes/index.tsx',
      },
      {
        path: ROUTES.ADMIN.DISHES.CREATE,
        component: '@/pages/admin/dishes/components/CreateDish',
      },
    ],
  },
  {
